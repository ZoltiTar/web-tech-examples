...
* **Solutions that are not based on the use of the `class` attribute are rejected. The same applies to solutions in which the HTML document contains Unicode emojis directly.**
...
* **You should properly indent both the HTML document and the stylesheet.** Note that improper indentation makes your code harder to read, understand, and change. Improper indentation decreases the score of your submission.

* You should use meaningful class names in the `class` attribute.
