...
* **Elutasításra kerülnek (0 pontot érnek) az olyan megoldások, amelyek nem a `class` attribútum használatán alapulnak. Ugyanez vontatkozik azokra a megoldásokra, amelyekben közvetlenül a HTML-dokumentumban vannak megadva Unicode emojik.**
...
* **Formázd megfelelően a HTML-dokumentumot és a stíluslapot is.** A nem megfelelő formázás megnehezíti a kód olvasását, megértését és módosítását. A nem megfelelő formázás a pontszámot csökkenti.
